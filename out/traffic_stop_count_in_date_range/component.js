...
System.register("app/optional_label/view_model.js", ["npm:systemjs-plugin-babel@0.0.16/babel-helpers/classCallCheck.js", "npm:systemjs-plugin-babel@0.0.16/babel-helpers/createClass.js", "knockout"], function (_export, _context) {
  ...
  var _classCallCheck, _createClass, Knockout, OptionalLabelViewModel;
...
System.registerDynamic("npm:semantic-ui-dropdown@2.2.3.json", [], false, function() {
  return {
    "main": "index.js",
    "format": "cjs",
    "meta": {
...
System.registerDynamic('npm:semantic-ui-dropdown@2.2.3/index.js', ['jquery'], true, function ($__require, exports, module) {
  var define,
      global = this || self,
      GLOBAL = global;
  /*!
  ...
  })($__require('jquery'), window, document);
...
System.registerDynamic("npm:semantic-ui-transition@2.2.3.json", [], false, function() {
  return {
    "main": "index.js",
    "format": "cjs",
    "meta": {
...
System.registerDynamic('npm:semantic-ui-transition@2.2.3/index.js', ['jquery'], true, function ($__require, exports, module) {
  var define,
      global = this || self,
      GLOBAL = global;
  /*!
...
System.register('app/searchable_dropdown_selector/view_model.js', ['npm:systemjs-plugin-babel@0.0.16/babel-helpers/classCallCheck.js', 'npm:systemjs-plugin-babel@0.0.16/babel-helpers/createClass.js', 'jquery', 'knockout', 'semantic-ui-dropdown', 'semantic-ui-transition'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, $, Knockout, Dropdown, Transition, SearchableDropdownSelectorViewModel;
  ...
  return {
    setters: [function (_npmSystemjsPluginBabel0016BabelHelpersClassCallCheckJs) {
      ...
      Knockout = _knockout.default;
    }, function (_semanticUiDropdown) {
      Dropdown = _semanticUiDropdown.default;
    }, function (_semanticUiTransition) {
      Transition = _semanticUiTransition.default;
    }],
    execute: function () {
    ...
    execute: function () {
      TrafficStopCountInDateRangeRequest = function () {
        ...
        _createClass(TrafficStopCountInDateRangeRequest, [{
          ...
          key: 'uri',
          value: function uri() {
            return URI("https://data.nola.gov/resource/nfft-hjwi").addQuery({ stopdescription: "TRAFFIC VIOLATION" }).addQuery({ $where: "eventdate between " + ('\'' + this.eventdateRangeBeginning() + '\' and ') + ('\'' + this.eventdateRangeEnd() + '\'') }).addQuery({ $select: "count(stopdescription)" });
          }
        }]);
    ...
    execute: function () {
      TrafficStopCountInDateRangeViewModel = function () {
        ...
        _createClass(TrafficStopCountInDateRangeViewModel, [{
          ...
          key: 'defaultEndDateDay',
          value: function defaultEndDateDay() {
          ...
          value: function defaultEndDateYear() {
